...
fun MainScreen() {
    ...
    val p2: Pregunta = Pregunta(
        ...
        true,
        R.drawable.laliga_hyper
    )
    val p3: Pregunta = Pregunta(
        "La UD Las Palmas ha disputado menos partidos en 1ª división que el CD Tenerife",
        false,
        R.drawable.cdt_escudo
    )
    val p4: Pregunta =
        Pregunta(
            "El máximo goleador de la historia del CD Tenerife es Suso Santana", false, R.drawable.laliga_hyper
        )
        ...
        Column(
            ...
            * */
            ...
            Row(
                ...
                Button(onClick = {
                    respuestaUsuario = true /*TODO -> Comprobar si es verdadero
                                      -> Cambiar color segun resultado */
                }) {
                    Text(text = "True", fontSize = 16.sp)
                }
                Button(onClick = {
                    respuestaUsuario = false/*TODO -> Comprobar si es falso
                                      -> Cambiar color segun resultado */
                }) {
